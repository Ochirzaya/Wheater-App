...
export const Card = () => {
  return (
    <div className="w-[414px] h-fit bg-[#111827bf] backdrop-blur-[12px] rounded-[48px]">
      <div className="flex items-center gap-[112px]  ">
        <div className="inline-flex  flex-col pl-[40px] py-[56px]">
          <p className="flex text-[18px] font-normal text-[#9CA3AF]">
            September 10, 2021
          </p>
          <p className="flex text-[48px] text-[#FFF]">Kraków</p>
        </div>
        <svg
      ...
      <div className="flex flex-col  items-start ">
        <p className="text-[144px] text-transparent  bg-clip-text bg-gradient-to-b from-white to-black px-[30px]">
          17°
        </p>
        <p className="text-[24px] text-[#777CCE] px-[40px]">Clear</p>
      </div>
